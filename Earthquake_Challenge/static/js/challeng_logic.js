...
// Create a third tile layer to be toggled as background of the map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(majorQuakeData) {
    ...
    // New function for Major Earthquakes layer colors
    ...
    // Function to determine circle radius for Major Earthquakes Layer
    ...
    L.geoJSON(majorQuakeData, {
      pointToLayer: function(feature, latlng) {
        console.log(majorQuakeData);
        return L.circleMarker(latlng);
      },
      style: styleInfo,
      onEachFeature: function(feature, layer) {
